        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartBookingTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndBookingTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Temporaries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Temporaries_TicketTypes_TicketTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_BookingDetails_BookingDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Temporaries_TicketTypeId",
                table: "Temporaries",
                column: "TicketTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Temporaries_UserId",
                table: "Temporaries",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_BookingDetailsId",
                table: "Tickets",
